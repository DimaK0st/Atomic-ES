...
class Constants
{
    ...
    static public float $URANIUM_PROGRESSION_KOEF = 1.9825;
    ...
    static public float $PLUTONIUM_PROGRESSION_KOEF = 2.12;
    ...
    static public float $CORE_STABILITY_THRESHOLD = 400;
    static public float $AVOGADRO = 6.022E+23;
    static public array $CORE_MATERIAL = ['Uranium' => 'Uranium', 'Plutonium' => 'Plutonium'];
    static public array $TEMPER_MATERIAL = ['None' => 'None', 'Uranium' => 'Uranium', 'Beryllium' => 'Beryllium'];
}
